import rich, click
from ._hi import hi, NAME_KEY

HI_FORMAT = '[green]Hello [yellow][italic]{name}[/yellow][/italic][green], how was your day?'
...
def _show_error(error: Exception, fmt):
    try:
        rich.print(f"[red bold]ERROR: [white]Invalid format string. [yellow underline italic]'{fmt}'")
