...
class RouteTableDef:
    ...
    def get(self, prefix: str):
        return self.route(METHOD.GET, prefix)

    def post(self, prefix: str):
        return self.route(METHOD.POST, prefix)

    def delete(self, prefix: str):
        return self.route(METHOD.DELETE, prefix)

    def put(self, prefix: str):
        return self.route(METHOD.PUT, prefix)
