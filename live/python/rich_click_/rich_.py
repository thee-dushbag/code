...
table = Table(
    *headers,
    ...
    caption=Text("This is a rich table.", justify="right"),box=box.SIMPLE
)
rows = [
...
def record():
    for i in range(1, 6):
        ...
        sleep(.5)
    with c.status("[blue bold][i]Counting to [/i][yellow]20...", spinner='bouncingBall', spinner_style='bold yellow reverse'):
        for i in range(1, 21):
