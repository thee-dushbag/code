...
@_c.command
@_c.option('--file', '-i', help='File to sort its lines.', type=_c.Path(exists=True, dir_okay=False))
@_c.option('--print0', help=r'Output file delimeter is \0 instead of newlines \n', is_flag=True)
@_c.option('--scan0', help=r'Input file delimeter is \0 instead of newlines \n', is_flag=True)
