...
from attrs import AttrsInstance, Attribute, define, field
...
class ValidatorNotFound(ValidationError):
    def __str__(self):
        return f'No Validator for {self.attr_name}={self.attr_value!r} in {self.validator}'
